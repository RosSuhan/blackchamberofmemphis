...
export const aTourOfPossibilities : BlackLedgerProp = {
    ...
    answerFive : `<p>ATOP recognizes persistent barriers to access, visibility, and control over whose stories shape opportunity. Mainstream tourism pipelines often exclude Black communities and cultural contributors, limiting both narrative ownership and economic benefit.</p>
                    <p>ATOP counters this pattern by intentionally centering Black voices, redirecting visitor attention and spending, and creating consistent pathways into neighborhoods and businesses that history has overlooked. This approach challenges extractive tourism models and replaces them with engagement rooted in respect, reciprocity, and community trust.</p>`,

    headingSix : `Creating Stability Through Consistency`,
