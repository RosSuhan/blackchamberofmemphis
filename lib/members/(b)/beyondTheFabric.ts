...
export const beyondTheFabric : MembersListType = {
    memberStatus: true,
    ...
    offering : `
        <ul style="text-align: left">
            ...
            <li>Business logo embroidery</li>
            <li>Personalized apparel</li>
            <li>Monogramming and initials</li>
            <li>Custom embroidered bags and accessories</li>
            <li>Personalized embroidered towels</li>
            <li>Custom designs for special occasions</li>
        </ul>`,
    busBullets : `
        <ul style="text-align: left">
