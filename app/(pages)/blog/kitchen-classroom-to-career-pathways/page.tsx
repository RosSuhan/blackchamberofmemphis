    ...
    return(
        <main>
            ...
            >
                ...
                >
                    <h1
                        className={style.kitchenBlogMainHeading}
                    >
                        Kitchen Classroom to Career Pathways
                    </h1>

                    <h2
                        className={style.kitchenBlogSubHeading}
                    >        
                ...
                <Image
                    src={'/blog/bcom_culinary_program/bcom-culinary-excellence-acknowledgements-3.webp'}
                    alt=""
                    width={4000}
                    height={1868}
            ...
            >
                {/* <h2>
                    From Kitchen Classrooms to Career Pathways: Investing in Memphis’ Next Generation
                </h2> */}
                <p
                    className={style.kitchenBlogArticleText}
                >
                    At the Black Chamber of Memphis, our work is rooted in a clear belief: when we invest in people, we strengthen the city’s entire ecosystem. Through our <strong>Business Booster Program</strong>, we’re not only supporting today’s entrepreneurs. We are intentionally building pathways for the next generation to step into opportunity, ownership, and long-term sustainability.
                </p>
                <p
                    className={style.kitchenBlogArticleText}
                >
                ...
                <Image
                    ...
                    width={4000}
                    height={1868}
                    className={style.kitchenBlogImage}
                />
                <h2
                    className={style.kitchenBlogArticleHeading}
                >
                ...
                <Image
                    src={'/blog/bcom_culinary_program/bcom-culinary-excellence-acknowledgements-9.webp'}
                    alt=""
                    width={4000}
                    height={1868}
                    className={style.kitchenBlogImage}
                ...
                <div
                    className={style.kitchenBlogArticleSpan}
            ...
            >
                ...
                <div
                    className={style.kitchenContactBlock}
                >
                    <h3
                        className={style.kitchenContactBlockHeading}
                    >
                        Sheffield Career & Technical Center
                    </h3>
                    <p
                        className={style.kitchenContactBlockText}
                    >
                        <strong>Instructor:</strong>
                        John Cooper
                    </p>
                    <a 
                        href="mailto:cooperjw@scsk12.org"
                        className={style.kitchenContactBlockLink}
                    >
                        cooperjw@scsk12.org
                    </a>
                </div>
                ...
                >
                    ...
                    <a 
                        href="mailto:millerjy@scsk12.org"
                        className={style.kitchenContactBlockLink}
                    >
                        millerjy@scsk12.org
                    </a>
            ...
            >
                <Image
                    src={'/blog/bcom_culinary_program/bcom-culinary-excellence-acknowledgements-6.webp'}
                    alt=""
                    width={1868}
                    height={4000}
                    className={style.kitchenBlogLongImage}
                />
            </section>
        </main>
    )
